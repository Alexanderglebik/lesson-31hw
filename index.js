...
let todoItemComponent = {
    ...
    <li class = "collection-item" >
        ...
        <i class="material-icons right" @click ="$emit('edit-item')"> create </i>
    </li>`
}
...
let todoButtonComponent = {
    template:`<button class="btn waves-effect waves-light" type="submit"> 
    <slot name="button"></slot>
</button>`
}

let todoTextComponent = {
...
new Vue({
    ...
    methods: {
        ...
        editTodoItem(itemIdx) {
            let newItem = prompt ('Введите новое задания');
            console.log(newItem)
            return this.todoItems[itemIdx].text=newItem;
        }
    }
});
